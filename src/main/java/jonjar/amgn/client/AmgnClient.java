...
// ...
        ...
        // ...
        private void setupFluidRendering(FlowableFluid stillMoltenChocolate, FlowableFluid flowingChocolate, Identifier identifier, int i) {
        }
        public static void setupFluidRendering(final Fluid still, final Fluid flowing, final Identifier textureFluidId, final int color)
        {
            ...
            ResourceManagerHelper.get(ResourceType.CLIENT_RESOURCES).registerReloadListener(new SimpleSynchronousResourceReloadListener()
            {
                ...
                {
                    final Function<Identifier, Sprite> atlas = MinecraftClient.getInstance().getSpriteAtlas(BLOCK_ATLAS_TEX);
